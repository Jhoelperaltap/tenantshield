...
> Estado: v1.12 — Consolidación post-Phase 4 (Rules 63-67 + Pool 4 absorbed).
> Última revisión: 2026-05-17.
> Tag de proyecto al revisar: `v0.4.0-alpha` (Phase 4 cerrada; AsyncSession + cross-adapter strategy unification).
